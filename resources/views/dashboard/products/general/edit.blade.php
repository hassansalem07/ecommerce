                    ...
                    <div class="card mt-2 mx-auto p-4 bg-light">
                        ...
                        <div class="controls">
                          <div class="row">
                            <div class="col-md-6">
                                ...
                                <input id="form_name" value="{{$product->name}}" type="text" name="name" class="form-control" placeholder="name">  
                                </div>
                                @error('name')
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="form_name" value="{{$product->slug}}" type="text" name="slug" class="form-control" placeholder="slug">  
                                </div>
                                @error('slug')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea id="form_description" name="description" class="form-control" placeholder="Write your message here." rows="4" >{{$product->description}}</textarea>
                                    </div>
                                    @error('description')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea id="form_short" name="short_description" class="form-control" placeholder="Write your message here." rows="2" >{{$product->short_description}}</textarea>
                                </div>
